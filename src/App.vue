...
.flow-container {
  ...
  /* background-image: url('05.jpg'); Replace with your image path */
  background-size: cover; /* Adjust how the image covers the container */
...
.custom-node::after {
  ...
  width: 10px;
  height: 10px;
  background-color: #ff6347; /* Tomato color for connection points */
  border-radius: 50%;
  position: absolute;
  top: -5px;
  left: 50%;
